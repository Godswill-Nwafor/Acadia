...
export class NotificationsController {
  ...
  getUnreadCount(@Param('userId') userId: string) { return this.service.getUnreadCount(userId); }

  @Patch(':id/read')
  markRead(@Param('id') id: string) { return this.service.markRead(id); }

  @Patch('user/:userId/mark-all-read')
  markAllRead(@Param('userId') userId: string) { return this.service.markAllRead(userId); }
}
