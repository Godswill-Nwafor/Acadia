...
import {
  ...
  Users, Calendar, Settings, Search, Bell,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex font-sans">
      ...
      <aside className="w-64 bg-sidebar text-sidebar-foreground flex flex-col shrink-0 h-screen sticky top-0">
        <div className="h-16 flex items-center px-5 border-b border-white/10">
          <Image src="/LOGO.png" alt="Acadia" width={120} height={32} className="brightness-0 invert" priority />
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="font-semibold text-white/80 text-sm truncate">Mountain Top</div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-16 flex items-center justify-between px-8 border-b border-border bg-white sticky top-0 z-40">
          ...
          <div className="flex items-center gap-5">
            <button type="button" className="relative text-muted-foreground hover:text-foreground transition-colors">
              ...
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-primary text-[10px] font-bold text-white flex items-center justify-center rounded-full border-2 border-white">3</span>
            </button>

            <div className="flex items-center gap-3 pl-5 border-l border-border">
              <div className="text-right hidden md:block">
                <div className="text-sm font-semibold text-foreground leading-none">Ayomide T.</div>
